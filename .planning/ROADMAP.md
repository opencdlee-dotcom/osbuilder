...
- [x] 08-04-PLAN.md — scripts/check_skill_versions.py first-session validator + ~/.osbuilder/last_check.txt marker (QUAL-05) — completed 2026-05-05, commit fa6f60b (216 lines pure stdlib; 4 RED→GREEN; pytest 200/10 vs 196 baseline; real-world dry-run case-b: gsd & predator warn, others pass silently, exit 0)
- [x] 08-05-PLAN.md — .github/workflows/ci.yml (lint-skill-md + test jobs, pinned @v6 actions) (QUAL-01 CI surface) — completed 2026-05-05, commit 6f478dd (33-line workflow; 2 jobs lint-skill-md → test with `needs:`; pinned @v6 / no @latest; 3 Wave 0 stubs RED→GREEN; pytest 203/7 vs 200/10 baseline)
- [x] 08-06-PLAN.md — README.md (install one-liner + dev-team metaphor + demo embed + --production-ready doc) (QUAL-02, QUAL-03, SC-6 verification) — completed 2026-05-05, commit fee4729 (154-line README; URL substituted from 08-URL-LOCK.md option-personal cdlee/osbuilder; 4/5 Wave 0 stubs RED→GREEN; test_demo_asset_present stays SKIP pending demo asset; pytest 207/3 vs 203/7 baseline; all 7 NAMED_UPGRADES + all 8 dev-team roles verbatim)
